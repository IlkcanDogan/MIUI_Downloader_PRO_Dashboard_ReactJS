    ...
    const handleSave = () => {
        if (form.downloadUrl) {
            ...
            db.child('/files').push({
                ...
                setForm({ ...initForm, modelTypeId: form.modelTypeId, romTypeId: form.romTypeId, uploadTypeId: form.uploadTypeId , _wait: false, _success: 'Başarı ile kaydedildi!' })
            }).catch(() => {
        ...
        <div className="container mt-4 mb-4">
            {select._wait ? (
                ...
                <React.Fragment>
                    ...
                    <button className="btn btn-success" style={{ minWidth: 80, marginRight: 10 }} disabled={form._wait} onClick={handleSave}>
